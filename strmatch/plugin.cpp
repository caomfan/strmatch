...
struct StringEntry
{
	...
	bool IsMatch(duint va, MatchMode mode, bool caseSensitive)
	{
		...
		auto cmdResult = memcmp(temp.data(), data, size);
		return cmdResult == 0;
	}
};
...
bool pluginInit(PLUG_INITSTRUCT* initStruct)
{
	...
	_plugin_registerexprfunction(pluginHandle, "strcmp_utf8", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strcmp_utf8, true);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "strcmp_utf16", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strcmp_utf16, true);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "strcmp_local", 2, [](int argc, const duint* argv, void* userData)
		{
			return magic_match(argv[0], argv[1], StringEntry::strcmp_local, true);
		}, nullptr);

	ValueType* pArgValueTypes = new ValueType[2]{};
	pArgValueTypes[0] = ValueType::ValueTypeAny;
	pArgValueTypes[1] = ValueType::ValueTypeNumber;
	_plugin_registerexprfunctionex(pluginHandle, "strcmp_local_ex", ValueType::ValueTypeNumber, pArgValueTypes, 2, [](ExpressionValue* result, int argc, const ExpressionValue* argv, void* userData) {
		result->type = ValueType::ValueTypeNumber;
		result->number = magic_match(argv[0].number, argv[1].number, StringEntry::strcmp_local, true);
		return true;
		}, nullptr);

	_plugin_registerexprfunction(pluginHandle, "stricmp_utf8", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strcmp_utf8, false);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "stricmp_utf16", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strcmp_utf16, false);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "stricmp_local", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strcmp_local, false);
		}, nullptr);

	_plugin_registerexprfunction(pluginHandle, "strstr_utf8", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strstr_utf8, true);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "strstr_utf16", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strstr_utf16, true);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "strstr_local", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strstr_local, true);
		}, nullptr);

	_plugin_registerexprfunction(pluginHandle, "stristr_utf8", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strstr_utf8, false);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "stristr_utf16", 2, [](int, const duint* argv, void*)
		{
			return magic_match(argv[0], argv[1], StringEntry::strstr_utf16, false);
		}, nullptr);
	_plugin_registerexprfunction(pluginHandle, "stristr_local", 2, [](int, const duint* argv, void*)
		{
